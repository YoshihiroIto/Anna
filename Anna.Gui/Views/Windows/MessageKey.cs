...
public static class MessageKey
{
    ...
    public const string JumpFolder = nameof(JumpFolder);
    ...
    public const string CompressEntry = nameof(CompressEntry);
    public const string DecompressEntry = nameof(DecompressEntry);
}